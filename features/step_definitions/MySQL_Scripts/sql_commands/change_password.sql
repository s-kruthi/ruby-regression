...
select*from epms_notifier_notification where trigger_id='User.PasswordChangedTrigger' And path_id='/20519' \G;

select*from epms_log_message WHERE subject="Reset Password" \G;
