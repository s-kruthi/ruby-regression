...
select*from epms_notifier_notification where trigger_id='User.ForgotUsernamePasswordTrigger' And path_id='/3472' \G;

select*from epms_log_message WHERE subject='Forgot Username or Password' \G;