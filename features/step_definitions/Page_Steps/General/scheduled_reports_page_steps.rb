...
def selectAReport(cat_pos_index_arrow_id, cat_pos_index_arrow_value, cat_pos_index_class, report_name_filter_index_value)
  sleep (1)
  SelectFromSelect2Dropdown(cat_pos_index_arrow_id, cat_pos_index_arrow_value, cat_pos_index_class, report_name_filter_index_value)
  sleep (1)
end
...
def selectAScheduledReportFilter(cat_pos_index_arrow_id, cat_pos_index_arrow_value, cat_pos_index_class, schd_report_filter_index_value)
    SelectFromSelect2Dropdown(cat_pos_index_arrow_id, cat_pos_index_arrow_value, cat_pos_index_class, schd_report_filter_index_value)
    sleep (1)
end
