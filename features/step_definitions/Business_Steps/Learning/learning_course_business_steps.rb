...
And(/^I Add New Course Details$/i) do
  ...
  EnterCourseTitle(NEW_COURSE_CODE_ID, NEW_COURSE_CODE_VALUE)
  ...
  EnterCourseRetrain_open(COURSE_RETRAIN_OPEN_INPUT_ID, COURSE_RETRAIN_OPEN_INPUT_VALUE) if COURSE_RETRAIN_OPEN.to_i == 1
