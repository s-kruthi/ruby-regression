...
And(/^I Enter New Form Template Details$/i) do
  ...
  Sleep_Until(SelectSingleFromSelect2InputDropdown(DOCUMENT_CATEGORY_ID, DOCUMENT_CATEGORY_DROPDOWN_SEARCH_CLASS, DOCUMENT_CATEGORY_TITLE_TEXT , DOCUMENT_CATEGORY_DROPDOWN_RESULT_CLASS))
