# ######### Employee Contracts page elements #############################
#
EMPLOYEE_CONTRACTS_TAB = "//a[@href='#collapseGeneral']"
EMPLOYEE_CONTRACT_LIST_PATH = "//span[contains(.,'Contract Library')]"

EMPLOYEE_NEW_CONTRACT_BTN = "//a[contains(.,'New Contract')]"

EMP_CONTRACT_TITLE_ID = "//input[@placeholder='Title']"

EMP_CONTRACT_CAT_INDEX_ID = "select2-choice"
