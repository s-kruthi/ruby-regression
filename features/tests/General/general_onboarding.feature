...
Feature:
  ...
  @general_user_add @general_high_risk @C21297
  ...
  @hr_add_contact_emergency @general_high_risk
  Scenario: [General]General User Editing Personal Details - Emergency Contact Details
    Given I Have Logged In As A Company Admin
  ...
  @hr_add_contact_nok @general_high_risk
  Scenario: [General]User Editing Personal Details - Next of Kin
    Given I Have Logged In As A Company Admin
    And   I Go To The "Menu Profile" Section
    And   I Click On "Personal Details" Sub Tab
