...
Feature:
  ...
  @document_assign @document_due @NotificationsDocuments
  ...
  @document_submitted_awaiting_approval @NotificationsDocuments
  ...
  @document_approved @NotificationsDocuments
  ...
  Scenario: [Documents]As A manager Review and Reject the Document Submitted by an User (# 1st level approval is set to Manager)
    Given I Am On The My Document Page Of A Manager
