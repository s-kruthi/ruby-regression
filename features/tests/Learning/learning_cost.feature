...
Feature: Manage cost category for learning
  ...
  @smoke_learning5 @create_new_learning_cost @C1802 @learning_high_risk @loc_transorm
  ...
  @smoke_learning5 @manipulate_learning_cost_category @C1802 @learning_high_risk @loc_transorm @loc_transorm
  Scenario: [Learning]Create A New Cost Category
    Given I Have Logged In As A Learning Admin
